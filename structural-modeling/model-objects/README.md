...
* `MatrixFormat='namedmat'` \[ `'namedmat'` \| `'plain'` \] - Return matrices `C` and `R` as either [`namedmat`](https://github.com/IRIS-Solutions-Team/IRIS-Reference-Manual/tree/4ef4f26be775395c124dd70eebeff9ddcd771395/structural-modeling/NamedMat/README.md) objects \(matrices with named rows and columns\) or plain numeric arrays.
